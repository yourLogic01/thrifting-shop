        ...
        <tbody>
          ...
          <tr>
            <td class="align-middle">
              {{-- {{ $cart_item->name }} --}}name <br>
              <span class="badge badge-success">
                {{-- {{ $cart_item->options->code }} --}}code
              </span>
            ...
            <td x-data="{ open{{ $cart_item->id }}: false }" class="align-middle text-center">
              <span x-show="!open{{ $cart_item->id }}"
                @click="open{{ $cart_item->id }} = !open{{ $cart_item->id }}">{{ $cart_item->price }}</span>
            ...
            <td class="align-middle text-center">
              {{ $cart_item->options->product_tax }}
            </td>

            <td class="align-middle text-center">
              {{ $cart_item->options->sub_total }}
            </td>
  ...
  <div class="form-row">
    <div class="col-lg-4">
      <div class="form-group">
        ...
        <input wire:model.blur="global_tax" type="number" class="form-control" name="tax_percentage" min="0"
